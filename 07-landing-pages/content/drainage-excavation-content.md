...
4. **Related Services grid links:** the current live page links to `/services/utility-excavation/` and `/slope-stabilization-eugene-oregon/`; this draft swaps those for confirmed live sibling routes (`/services/grading-leveling/`, `/services/foundation-excavation/`, `/services/septic/`, `/services/excavation/`) per the brief's flag — confirm with dev whether the original two routes are live before treating this swap as final.
