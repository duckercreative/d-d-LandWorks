...
| **Slug** | `land-clearing` |
| **Page type** | Core service page — P0 priority, home-pack-adjacent, with a live sibling page at `/brush-clearing-eugene-oregon/` (see §0-equivalent Scope Boundary Finding, folded into §3 and §6 below) |
