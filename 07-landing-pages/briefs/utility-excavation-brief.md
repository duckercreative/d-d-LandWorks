...
| 7 | Do I Need a Permit for a New Utility Line? | Gap #15 — brief permit-awareness note, deliberately short since fuller permit content lives elsewhere | Short answer-first (60-80 words) + cross-link to `/services/excavation/`'s and `/site-preparation-contractor-eugene-oregon/`'s fuller permit sections rather than duplicating |
