...
| Calls from GBP | GBP Insights + CallRail | Target: 80/month by M3 | If below → post more, add photos, lift review-reply rate |
...
| ~~Q&A additions~~ | — | **Dead metric — drop it.** GBP Q&A removed by Google late 2025 | Track on-site FAQ coverage + review-reply rate instead |
...
| Competitor GBP activity | Check photos, posts, services, review reply rate | What are they doing that's working? |
