...
The rules and blocks for writing the post body in Phase 4. Everything here is pulled from `04-gmb/profiles/houston/calendars/master/annual-calendar-2026-2027.md` and `copy_builder.py` behavior. Always read those files too — if they disagree with this document, they win.
...
When Phase 2 decides to write a new template, append this structure to the right season array in `04-gmb/profiles/houston/posts/templates.json`:
