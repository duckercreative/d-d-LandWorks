...
Source: `04-gmb/gbp-posts-calendar.md` — read lines 1–40 (the "POST COPY STANDARDS" block).
...
File: `04-gmb/posts/scheduled/queue.json`
...
File: `04-gmb/posts/templates/post_templates.json`
